...
// Dubai color theme (gold and blue)
const theme = {
  primary: "#0a0a0a",
  secondary: "#1a1a1a",
  accent: "#d4af37", // Gold
  accent2: "#0056b3", // Dubai blue
  bg: "#f0f0f0",
  card: "#ffffff",
  border: "#e0e0e0",
...
const hotels = [
  ...
  },
  {
    ...
    description: "Underwater-themed resort with waterpark and marine habitats",
    price: 800 * AED_TO_KES,
    images: [
      "https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1564501049412-61c2a3083791?auto=format&fit=crop&w=800&q=80",
    ],
    tags: ["Family", "Waterpark", "Resort"],
  },
];
...
const DubaiPage = () => {
  ...
  const [mpesaCode, setMpesaCode] = useState(""); // Store MPESA code
  const [paymentTimestamp, setPaymentTimestamp] = useState(""); // Store payment timestamp
  ...
  const simulateSTKPush = async () => {
    ...
    // Generate MPESA code and timestamp once per booking
