...
// Paris color theme (navy blue and pink)
const theme = {
  primary: "#2c3e50", // Navy blue
  secondary: "#e84393", // Romantic pink
  accent: "#2c3e50", 
  accent2: "#fd79a8", // Lighter pink
  bg: "#f8f9fa",
  card: "#ffffff",
  border: "#dfe6e9",
...
const hotels = [
  {
    ...
    description: "Legendary luxury hotel on Place Vendôme with Chanel spa",
    ...
    tags: ["Palace", "Luxury", "Historic"],
  },
  {
    name: "Le Meurice",
    description: "Ducasse restaurant overlooking Tuileries Garden",
    price: 750 * EUR_TO_KES,
    images: [
      "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1564501049412-61c2a3083791?auto=format&fit=crop&w=800&q=80",
    ],
    tags: ["Elegant", "Gourmet", "Central"],
  },
];
        ...
        >
          <motion.div
            ...
            style={{
              ...
              overflow: "auto",
              position: "relative",
              boxShadow: `0 0 0 2px ${theme.secondary}`,
            }}
          >
            <button
              onClick={closeModal}
                  ...
                  {modalHotel.images.map((_, i) => (
                    <button
                      ...
                      style={{
                        width: "10px",
                        height: "10px",
                        background: i === modalImageIdx ? theme.secondary : "rgba(255,255,255,0.5)",
                        border: "none",
                        cursor: "pointer",
                        padding: 0,
                      }}
                    ...
                    <div style={{
                      ...
                      <button
                        ...
                        style={{
                          width: "100%",
                          padding: "16px",
                          background: isProcessing ? "#ccc" : theme.secondary,
                          color: "#fff",
                          border: "none",
                          fontWeight: 700,
                          cursor: "pointer",
        ...
        {`
          * {
          ...
          input:focus, textarea:focus {
            ...
            box-shadow: 0 0 0 2px ${theme.secondary}33;
          }
          @keyframes spin {
