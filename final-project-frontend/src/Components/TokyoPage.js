...
// Tokyo color theme (inspired by traditional Japanese colors)
const theme = {
  primary: "#cb1b45", // Japanese red (akabeni)
  secondary: "#3a5f0b", // Japanese green (moegi)
  accent: "#8e354a", // Plum color (umenezumi)
  accent2: "#e2943b", // Persimmon color (kaki)
  bg: "#f9f4e6", // Japanese paper color
  card: "#ffffff",
  border: "#d9c6b5", // Light Japanese paper border
  shadow: "rgba(0,0,0,0.1)",
  text: "#333",
  lightText: "#888",
};

const JPY_TO_KES = 0.85; // 1 JPY = 0.85 KES

const hotels = [
  {
    name: "Park Hotel Tokyo",
    description: "Luxury hotel with panoramic views of Tokyo Tower and Mount Fuji",
    ...
    tags: ["Luxury", "City Views", "Shiba Park"],
  },
  {
    name: "Ryokan Sawanoya",
    description: "Authentic Japanese inn with tatami rooms and communal baths",
    price: 15000 * JPY_TO_KES,
    images: [
      "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=800&q=80",
      "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=800&q=80",
    ],
    tags: ["Traditional", "Ryokan", "Ueno"],
  },
];
